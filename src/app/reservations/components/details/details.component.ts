...
import { ReservationModel, ReservationStatus, ReservationType, updateReservationInterface } from '../../models/reservations.model';
...
@Component({
    ...
    standalone: true,
    imports: [MatCardModule, CommonModule, MatButton, MatIconModule, MatMenuModule],
...
export class DetailsComponent {
    ...
    delete(): void {
        ...
        dialogRef.afterClosed().subscribe(result => {
            if (result && this.reservation) {
                this.store.dispatch(ReservActions.deleteReservations({ id: this.reservation.id }));
            }
        });
    }
    ...
    updateReservation(reservation: ReservationModel, payload: Partial<updateReservationInterface>): void {
    ...
    changeReservationType(reservation: ReservationModel, type: ReservationType) {
        ...
        this.store.dispatch(ReservActions.updateReservations({ id, payload: partialUpdate }));
    }
}
